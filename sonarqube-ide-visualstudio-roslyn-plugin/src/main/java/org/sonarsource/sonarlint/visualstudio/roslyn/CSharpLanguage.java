...
public class CSharpLanguage extends AbstractLanguage {
  ...
  public CSharpLanguage(Configuration configuration) {
    super(SqvsRoslynPluginConstants.LANGUAGE_KEY, SqvsRoslynPluginConstants.LANGUAGE_NAME);
    this.configuration = configuration;
  }

  @Override
  public String[] getFileSuffixes() {
    return configuration.getStringArray(SqvsRoslynPluginPropertyDefinitions.FILE_SUFFIXES_KEY);
  }
